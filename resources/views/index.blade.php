...
<div id="carouselExampleIndicators" class="carousel slide" data-ride="carousel">
    ...
    <div class="carousel-inner">
        ...
        <div class="carousel-item">
            ...
            <div class="carousel-caption d-none d-md-block">
                <h1 class="display-4">Mengapa Harus Berbelanja Di <br> <span class="font-weight-bold">Flowelto
                        Shop?</span></h1>
                <hr class="my-4">
                <p class="lead">Karena Kami Selalu Merawat Dan Memastikan Bunga Tetap Indah Sebelum Sampai Ke Tempat
                    Anda</p>
                <a class="btn btn-primary btn-lg font-weight-bold" href="#categoryShop" role="button">SEE OUR FEATURED
                    FLOWERS</a>
            </div>
        </div>
        <div class="carousel-item">
            ...
            <div class="carousel-caption d-none d-md-block">
                <h1 class="display-4">Dapatkan Penawaran Menarik Bagi Pengguna Baru <br> <span
                        class="font-weight-bold">Up To 50%</span></h1>
                <hr class="my-4">
                <a class="btn btn-primary btn-lg font-weight-bold" href="{{url('/register')}}" role="button">SIGN UP
                    NOW</a>
            </div>
        </div>
    </div>
...
<div class="container">
        ...
        <div class="col-lg-4">
            <div class="card" style="height:37rem;">
                <a href="{{url('/'. $flowers[$i-1]->slug)}}">
                    <img src="{{asset('/storage/flower/'.$flowers[$i-1]->flower_img)}}" class="card-img-top"
                        alt="Gambar Bunga" height="360">
                </a>
                <div class="card-body bg-white">
                    <h5 class="card-title">{{$flowers[$i-1]->flower_name}}</h5>
                    <p class="card-text">Rp.{{$flowers[$i-1]->flower_price}}</p>
                    <p class="card-text">{{substr($flowers[$i-1]->flower_description,0,140)}}</p>
                </div>
            </div>
        </div>
        @endfor
        ...
        <div class="col-lg-4">
            <div class="card " style="height: 35rem;">
                ...
                <div class="card-body bg-white">
                    ...
                    <p class="card-text">Rp.{{$flct->flower_price}}.</p>
                    <p class="card-text">{{substr($flct->flower_description,0,150)}}</p>
                </div>
    ...
    <div class="text-center" style="margin-top: 50px">
        <a href="{{url('/category/'. $category[0]->slug)}}" class="btn btn-info btn-lg text-white text-uppercase">VIEW
            ALL {{$category[0]->category_name}}</a>
    </div>
    <br><br>
    ...
    <div class="text-center" style="margin-top: 50px">
        <a href="{{url('/category/'. $category[1]->slug)}}" class="btn btn-info btn-lg text-white text-uppercase">VIEW
            ALL {{$category[1]->category_name}}</a>
    </div>
</div>
            ...
            <a href="{{url('/category/'. $ctg->slug)}}" class="text-decoration-none text-dark">
                <div class="kotak">
                    <div class="img-hover-zoom text-center">
                        <img class="rounded-circle" src="{{asset('storage/category/'.$ctg->category_img)}}"
...
<div class="container">
    <div class="row">
        <div class="col-sm-6">
            ...
            <p>Flowelto Shop is a flower house located in West Jakarta, Kebon Jeruk. We've been serving you since 2020
                and it feels amazing to be a "Messenger" to our beloved customers for the past years. Professionally
                curated by a local expert La Madame Florist, with more than hundreds of bouquet, flower box, flower
                basket and gift options to choose from, whatever may be the occasion: season’s greeting, anniversary,
                graduation wishes, birthday, valentines, wedding, engagement, newborn, Christmas, Eid Mubarak and many
                more categories that cover the entire canvas of life.</p>
            <p>It is perhaps the most used and successful form of communicating your feelings to those you care about.
                At Flowelto Shop, we realize the worth of your emotions which is what makes us the number one choice for
                sending out your love to dear ones. Be it a happy occasion or a sad one. Flowelto Shop is just a click
                away.</p>
